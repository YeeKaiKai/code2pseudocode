...
const claudeApi_1 = __webpack_require__(2);
function activate(context) {
    ...
    const disposable = vscode.commands.registerCommand('code2pseudocode.convertToPseudocode', async () => {
        ...
        // 獲取 Claude API Key
        let apiKey = vscode.workspace.getConfiguration('code2pseudocode').get('claudeApiKey');
        if (!apiKey) {
        ...
        await vscode.window.withProgress({
            ...
            try {
                ...
                // 呼叫 Claude API
                const pseudocode = await (0, claudeApi_1.codeToPseudocode)(selectedText, apiKey);
                ...
                vscode.window.showErrorMessage(`轉換失敗: ${error.message}`);
            }
        });
    });
 ...
 */
async function showPseudocodePanel(originalCode, pseudocode) {
    // 創建 WebView 面板
    const panel = vscode.window.createWebviewPanel('code2pseudocode', 'Code to Pseudocode', vscode.ViewColumn.Beside, // 在側邊顯示
    {
        enableScripts: true,
 ...
 */
function getWebviewContent(originalCode, pseudocode) {
    return `
    <!DOCTYPE html>
    <html lang="zh-TW">
    <head>
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.codeToPseudocode = codeToPseudocode;
 ...
 * @returns pseudocode
 */
async function codeToPseudocode(code, apiKey) {
    if (!apiKey) {
